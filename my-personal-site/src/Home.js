        ...
        <div id="home">
            <div id="welcome">
                ...
                <div id="imgOne" onClick={()=> setImgToggle(prev => !prev)}>
                    {imgToggle?
                    <>
                    <img  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRuwothrknZ_T4kNmJ7zcC5o6hoTemc62g7cw&usqp=CAU" style={{"pointerEvents": "all"}} style={{"width":"80%"}}/>
                    <p>Love</p>
                    </>
                       : 
                       <p>{lover}</p>
                ...
                <div id="imgTwo" onClick = {() => setImgToggleTwo(prev => !prev)}>
                    {imgToggleTwo?
                    <>
                    <img src="https://knowledge.insead.edu/sites/www.insead.edu/files/images/2020/04/gettyimages-628537464-1.jpg" style = {{"width":"75%"}}/>
                    <p>Life</p>
                    </>
                    : 
                    <p>{lifer}</p>
                ...
                <div id= "imgThree" onClick = {() => setImgToggleThree(prev => !prev)}>
                        {imgToggleThree?
                        <>
                        <img src="https://i.pinimg.com/originals/57/ff/cc/57ffcc4f2b055a8f815c51a7bebd79c5.jpg" style={{"width":"75%"}}/>
                        <p>Random Advice!!</p>
                        </>
                        :
                        <p>{props.Advice}</p>}
